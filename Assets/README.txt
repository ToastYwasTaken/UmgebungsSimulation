...
-Water:
	- I used a water shader and placed Splash-particle-systems to the waterfall.

-Destroyed bridge:
	- Destroyed burning cars (fire-particle-system)
	- Destroyed bridge
	- Spark-effect on electric cables 

-Snowy hills:
	- Added appropriate textures on terrain
